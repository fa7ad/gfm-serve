...
func serveMiddleware(c *fiber.Ctx) error {
	...
	styleTag.AppendChild(&html.Node{
		Type: html.TextNode,
		Data: Css,
	})
	...
	h1.Parent.AppendChild(styleTag)

	header := &html.Node{
		Type: html.ElementNode,
		Data: "header",
	}
	h1.Parent.AppendChild(header)
	...
	for _, listItem := range listItems {
		if strings.HasPrefix(listItem.FirstChild.LastChild.Data, ".") {
